...
{
  "exports": {
    "./client": { "default": "./.output/client/index.js", "types": "./.output/client/index.d.ts" },
    "./server": { "default": "./.output/server/index.js", "types": "./.output/server/index.d.ts" },
    "./server/db-schemas": {
      "default": "./.output/server/db/schema/index.js",
      "types": "./.output/server/db/schema/index.d.ts"
    }
  }
}
```
...
- All 8 unit config types and unit type exports
