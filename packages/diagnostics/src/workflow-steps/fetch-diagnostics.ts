...
export const fetchLabTestStep = WorkflowStep.name("diagnostics-fetch-lab-test")
  .input(ByIdSchema)
...
export const fetchLabOrderStep = WorkflowStep.name("diagnostics-fetch-lab-order")
  .input(ByIdSchema)
...
export const fetchLabSampleStep = WorkflowStep.name("diagnostics-fetch-lab-sample")
  .input(ByIdSchema)
...
export const fetchRadioBookingStep = WorkflowStep.name("diagnostics-fetch-radio-booking")
  .input(ByIdSchema)
