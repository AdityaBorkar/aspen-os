...
export const fetchEncounterStep = WorkflowStep.name("diagnostics-fetch-encounter")
 ...
 */
export const fetchOpenEncounterStep = WorkflowStep.name("diagnostics-fetch-open-encounter")
