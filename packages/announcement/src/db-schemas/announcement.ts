...
export const announcement = pgTable(
  ...
  (table) => [
    ...
    index("idx_announcement_author").on(table.author),
    index("idx_announcement_scheduled_for").on(table.scheduled_for),
  ],
);

export const announcementRecipient = pgTable(
  ...
  (table) => [
    index("idx_announcement_recipient_announcement_id").on(table.announcement_id),
    index("idx_announcement_recipient_user_id").on(table.user_id),
  ],
);
