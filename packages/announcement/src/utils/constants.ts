export const ANNOUNCEMENT_PERMISSION_MODULE = {
  ANNOUNCEMENT: "announcement",
} as const;

export type AnnouncementPermissionModule =
  (typeof ANNOUNCEMENT_PERMISSION_MODULE)[keyof typeof ANNOUNCEMENT_PERMISSION_MODULE];
