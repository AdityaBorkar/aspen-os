...
| `masters.org_branch_created`        | annual `trade_license` obligation + `trade_license` + `fire_safety_certificate` docs |
...
// subscribes 6 topics, each schema-validated; handler → documents.create / obligations.create
```
