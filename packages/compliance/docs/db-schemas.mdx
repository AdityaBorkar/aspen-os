...
| `expiry_policy_channel` | `email`, `pubsub`, `both`                                                                                                                                                                                                                                                        |
...
| `expiry_policy_days`    | `integer[] default [90,60,30,7]`            | Days before expiry to remind                    |
| `escalation_days`       | `integer[]`                                 | Days after expiry to escalate                   |
| `expiry_policy_channel` | `expiry_policy_channel default pubsub`      | How to send reminders                           |
...
| `default_expiry_policy_days` | `integer[]`                            | Default expiry policy days |
