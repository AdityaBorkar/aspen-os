...
export const fetchPharmacyItemStep = WorkflowStep.name("healthcare-fetch-pharmacy-item")
  .input(ByIdSchema)
...
export const fetchPharmacyBatchStep = WorkflowStep.name("healthcare-fetch-pharmacy-batch")
  .input(ByIdSchema)
...
export const fetchPharmacySaleStep = WorkflowStep.name("healthcare-fetch-pharmacy-sale")
  .input(ByIdSchema)
...
export const fetchPurchaseOrderStep = WorkflowStep.name("healthcare-fetch-purchase-order")
  .input(ByIdSchema)
...
export const fetchGrnStep = WorkflowStep.name("healthcare-fetch-grn")
  .input(ByIdSchema)
...
export const fetchStockTransferStep = WorkflowStep.name("healthcare-fetch-stock-transfer")
  .input(ByIdSchema)
