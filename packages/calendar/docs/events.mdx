---
title: Events
description: Domain event map for the Calendar module — 13 events across 4 event groups.
icon: IconBell
---

The Calendar module defines 13 domain events in 4 groups. Events are type-level contracts published as plain string topics via PubSub.
