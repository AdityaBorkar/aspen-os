...
import { setPrimary as setPrimaryAddress } from "./workflows/address.set-primary";
...
import { setPrimary as setPrimaryBankAccount } from "./workflows/bank-account.set-primary";
...
import { addNote } from "./workflows/connection.add-note";
import { archiveConnection } from "./workflows/connection.archive";
import { createConnection } from "./workflows/connection.create";
import { createContact } from "./workflows/connection.create-contact";
import { deleteContact } from "./workflows/connection.delete-contact";
import { getConnection } from "./workflows/connection.get";
import { listConnections } from "./workflows/connection.list";
import { listContacts } from "./workflows/connection.list-contacts";
import { listNotes } from "./workflows/connection.list-notes";
import { restoreConnection } from "./workflows/connection.restore";
import { searchConnections } from "./workflows/connection.search";
import { searchContacts } from "./workflows/connection.search-contacts";
import { setPrimaryContact } from "./workflows/connection.set-primary-contact";
import { updateConnection } from "./workflows/connection.update";
import { updateContact } from "./workflows/connection.update-contact";
import { updateStatus } from "./workflows/connection.update-status";
import { createOrganization } from "./workflows/org.create";
import { deleteLogo } from "./workflows/org.delete-logo";
import { getOrganization } from "./workflows/org.get";
import { updateOrganization } from "./workflows/org.update";
import { updateBranding } from "./workflows/org.update-branding";
import { uploadLogo } from "./workflows/org.upload-logo";
