    ...
    return {
      ...
      db: {
        control_plane_schemas: {
          department: dbSchema.department,
          designation: dbSchema.designation,
          employeeGrade: dbSchema.employeeGrade,
          employmentType: dbSchema.employmentType,
          holiday: dbSchema.holiday,
          holidayList: dbSchema.holidayList,
          hrPermission: dbSchema.hrPermission,
          hrRole: dbSchema.hrRole,
          hrRolePermission: dbSchema.hrRolePermission,
          hrSettings: dbSchema.hrSettings,
          hrUser: dbSchema.hrUser,
          hrUserBranchAccess: dbSchema.hrUserBranchAccess,
          hrUserRole: dbSchema.hrUserRole,
          payrollSettings: dbSchema.payrollSettings,
        },
        tenant_schemas: {
          attendance: dbSchema.attendance,
          attendanceRequest: dbSchema.attendanceRequest,
          compensatoryLeaveRequest: dbSchema.compensatoryLeaveRequest,
          employee: dbSchema.employee,
          employeeCheckin: dbSchema.employeeCheckin,
          employeeGroup: dbSchema.employeeGroup,
          employeeGroupMember: dbSchema.employeeGroupMember,
          employeeHealthInsurance: dbSchema.employeeHealthInsurance,
          employeeOnboarding: dbSchema.employeeOnboarding,
          employeePromotion: dbSchema.employeePromotion,
          employeeSeparation: dbSchema.employeeSeparation,
          employeeSkillMap: dbSchema.employeeSkillMap,
          employeeTransfer: dbSchema.employeeTransfer,
          exitInterview: dbSchema.exitInterview,
          fullAndFinalStatement: dbSchema.fullAndFinalStatement,
          leaveAdjustment: dbSchema.leaveAdjustment,
          leaveAllocation: dbSchema.leaveAllocation,
          leaveApplication: dbSchema.leaveApplication,
          leaveBlockList: dbSchema.leaveBlockList,
          leaveEncashment: dbSchema.leaveEncashment,
          leaveLedgerEntry: dbSchema.leaveLedgerEntry,
          leavePeriod: dbSchema.leavePeriod,
          leavePolicy: dbSchema.leavePolicy,
          leavePolicyAssignment: dbSchema.leavePolicyAssignment,
          leavePolicyDetail: dbSchema.leavePolicyDetail,
          leaveType: dbSchema.leaveType,
          onboardingTask: dbSchema.onboardingTask,
          overtimeSlip: dbSchema.overtimeSlip,
          overtimeType: dbSchema.overtimeType,
          separationTask: dbSchema.separationTask,
          shiftAssignment: dbSchema.shiftAssignment,
          shiftLocation: dbSchema.shiftLocation,
          shiftRequest: dbSchema.shiftRequest,
          shiftSchedule: dbSchema.shiftSchedule,
          shiftScheduleAssignment: dbSchema.shiftScheduleAssignment,
          shiftType: dbSchema.shiftType,
        },
      },
      events: {
