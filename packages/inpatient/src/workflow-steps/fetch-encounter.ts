...
export const fetchEncounterStep = WorkflowStep.name("inpatient-fetch-encounter")
 ...
 */
export const fetchOpenEncounterStep = WorkflowStep.name("inpatient-fetch-open-encounter")
