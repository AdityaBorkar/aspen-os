...
export const diagnostics = definePackageDocs("diagnostics");
export const pharmacy = definePackageDocs("pharmacy");
export const emr = definePackageDocs("emr");
export const inpatient = definePackageDocs("inpatient");
